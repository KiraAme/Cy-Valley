...
void draw_completed_quests(Screen* pScreen, Model* pModel, char* buffer){
        ...
        drawText(pScreen, (pScreen->width - CAMERA_SIZE) / 2 + 19, (pScreen->height - CAMERA_SIZE) / 2 + 10, buffer, 0);
}
...
void draw_coordonates(Screen* pScreen, Model* pModel, char* buffer9, char* buffer10, char* buffer, char* buffer2, char* buffer8){
...
void draw_ui(Screen* pScreen, Model* pModel){
        ...
        draw_coordonates(pScreen, pModel, buffer9, buffer10, buffer, buffer2, buffer8);
}
